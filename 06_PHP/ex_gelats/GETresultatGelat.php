...
<body>
    <?php 
        if(isset($_GET["tipusGelat"])){
            $tipus = $_GET["tipusGelat"];
        }
        else{
            $tipus = "Selecciona un gelat";
        }
        $gelats = array(
            array("ConXocoPetit.png", "ConXocoMig.png", "ConXocoGran.png");
            array("ConMaduixaPetit.png", "ConMaduixaMig.png", "ConMaduixaGran.png");
        )
    ?>
